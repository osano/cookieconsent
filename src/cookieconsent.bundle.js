    ...
    function appendMarkup(markup) {
      ...
      if (opts.autoAttach) {
        try {
          ...
          throw new Error("No container to attach too. Make sure the DOM has loaded. Is your script loaded after the `</body>` tag.");
        }
      }
