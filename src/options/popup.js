...
export default {
  ...
  content: {
    ...
    customizeMessage: 'Here is overview of cookies we use on this site. Select categories which you are OK with. You can also change your choices at any time, by hitting the “Your Consent Options” link on the site\'s footer.',
    acceptSelected: 'Accept Selected',
    categoryAnalytics: 'These cookies collect information to help us understand how our website is being used. They allow us to count visits and traffic sources so that we can measure and improve the content of our site.',
  ...
  elements: {
    ...
    customizeCategories: `<ul class="sanddev-categories">` +
      ...
      + '</ul>',
    policiesLinks: `<div>For more information, please see our
      <a class="cc-link" href="{{hrefCookiePolicy}}" rel="noopener noreferrer nofollow" target="_blank">Cookie Policy</a> / 
      <a class="cc-link" href="{{hrefPrivacyPolicy}}" rel="noopener noreferrer nofollow" target="_blank">Privacy Policy</a>.</div>`
