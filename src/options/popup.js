...
export default {
  ...
  elements: {
    ...
    policiesLinks: `<div class="cc-policies-links">For more information, please see our 
      <a class="cc-link" href="{{cookiePolicyLink}}" rel="noopener noreferrer nofollow" target="_blank">Cookie Policy</a> / 
      <a class="cc-link" href="{{privacyPolicyLink}}" rel="noopener noreferrer nofollow" target="_blank">Privacy Policy</a>.</div>`
