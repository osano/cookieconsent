  ...
  cc.Popup = (function() {
    var defaultOptions = {
      ...
      content: {
        ...
        dismiss: 'Got it!',
        AriaLabelDismiss:'Dismiss cookie message',
        allow: 'Allow cookies',
        AriaLabelAllow:'Allow cookies',
        deny: 'Decline',
        AriaLabelDeny:'Deny cookies',
        link: 'Learn more',
        AriaLabelLink:'Learn more about our cookies policy',
      ...
      elements: {
        ...
        message:
          '<p id="cookieconsent:desc" class="cc-message">{{message}}</p>',
        messagelink:
          '<p id="cookieconsent:desc" class="cc-message">{{message}} <a aria-label="{{AriaLabelDismiss}}" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a></p>',
        dismiss:
          '<a aria-label="{{AriaLabelDismiss}}" role=button tabindex="0" class="cc-btn cc-dismiss">{{dismiss}}</a>',
        allow:
          '<a aria-label="{{AriaLabelAllow}}" role=button tabindex="0"  class="cc-btn cc-allow">{{allow}}</a>',
        deny:
          '<a aria-label="{{AriaLabelDeny}}" role=button tabindex="0" class="cc-btn cc-deny">{{deny}}</a>',
        link:
          '<a aria-label="{{AriaLabelLink}}" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a>',
        close:
          '<a aria-label="{{AriaLabelDismiss}}" role=button tabindex="0" class="cc-close">{{close}}</a>'
      ...
      window:
        '<div role="dialog" aria-live="polite" aria-describedby="cookieconsent:desc" class="cc-window {{classes}}"><!--googleoff: all-->{{children}}<!--googleon: all--></div>',
